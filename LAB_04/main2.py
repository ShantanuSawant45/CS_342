...
def plot_dft_spectrum(dft, title_prefix="", save_name="dft"):
    ...
    im1 = ax1.imshow(magnitude, cmap='hot', interpolation='nearest')
    ...
    im2 = ax2.imshow(log_magnitude, cmap='hot', interpolation='nearest')
    ...
    im3 = ax3.imshow(phase, cmap='twilight', interpolation='nearest')
    ...
    ax4.plot_surface(X, Y, log_magnitude, cmap='hot', edgecolor='none', alpha=0.8)
